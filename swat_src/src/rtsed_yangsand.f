...
!!    Plus particle size tracking.
      ...
      real :: alog10cychppm, c, cychppm, cychv, cychw, dat2, deg1
      real :: deg1cla, deg1gra, deg1lag, deg1sag, deg1san, deg1sil
      real :: degremain, pbank, pbed, rh, sedinorg, sfbank
      real :: topw, var1, var2, var3, var4, var5, var6, var56
      real :: vcla, vgra, vlag, vsag, vsan, vsh, vsil, w50
