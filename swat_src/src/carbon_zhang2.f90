subroutine carbon_zhang2
    ...
    !KOC     : liquid杝olid partition coefficient for microbial biomass (10^3 m^3 Mg-1)
    ...
    !CS      : combined factor controlling biological processes [CS = sqrt(CDG譙UT)* 0.8*OX*X1), CS < 10; CS = 10, CS>=10 (Williams, 1995)]
